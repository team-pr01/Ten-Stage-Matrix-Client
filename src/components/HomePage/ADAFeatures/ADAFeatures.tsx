    ...
    const adaFeatured = [
        {
            ...
            title : "Geo Dispersed",
            description : "We have redundant servers spread out all over the world. Not only does this ensure our blocks transmit fast and efficiently."
        },
        {
            icon : ICONS.lowLatency,
            title : "Low Latency",
            description : "Standbys are used during upgrades and in the unlikely event of server failure, another automatically and immediately takes it place."
        },
        {
            icon : ICONS.scalable,
            title : "Scalable",
        ...
        },
        {
            ...
            description : "Higher pledged pools pay higher rewards. OASIS is among the top 1% highest pledged public pools and is self-funded."
        },
    ]
  return (
    <div>
      <Container>
        <div className="flex items-center w-full">
            <img src={IMAGES.adaFeature} alt="" className="" />

        <div className="w-[55%]">
          <h1 className="text-[48px] font-medium text-white">
            What Can I Do With ADA?
          </h1>
          <p className="text-neutral-40 mt-[17px]">
