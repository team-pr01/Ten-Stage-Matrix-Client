...
const RecentActivity = () => {
  ...
  return (
    <div className="rounded-[15px] border-[3px] border-neutral-25/20 bg-neutral-30 flex flex-col py-7 px-[34px] font-Outfit w-full h-full overflow-y-auto custom-scrollbar mt-6">
