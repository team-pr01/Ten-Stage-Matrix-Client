...
const Levels = () => {
  return (
    <div className="font-Outfit grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-6">
      <Link
        ...
        className="rounded-[28px] border border-primary-50 bg-neutral-90/10 p-[30px] flex flex-col gap-[30px] items-center text-center"
      >
